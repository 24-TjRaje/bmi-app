    ...
    stages {
        ...
        stage('Creating and pushing docker image') {
            ...
            steps {
                ...
                sh 'docker login -u $DOCKER_CREDS.USR -p $DOCKER_CREDS.PSW'
                sh 'docker push $DOCKER_CREDS.USR/${IMAGE_NAME}:${BUILD_NUMBER}'
            }
        ...
        stage('Running the container') {
            ...
            steps {
                ...
                sh 'docker run --name ${CONTAINER_NAME} -d -p 82:8083 ${IMAGE_NAME}'
            }
        }    
    }
